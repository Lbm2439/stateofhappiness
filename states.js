  ...
  $(".hint ").click(function() {
    ...
    $.ajax({
      ...
      success: function(html) {
        ...
        $("#mentalInfo").append(
          Math.round(10 * incomeResult.Episode) / 10 + "%"
        );
      }
    });
    ...
    var dictionaryURL =
      ...
      foundState +
      "?key=49bde772-aaaf-42cf-a691-47d34eeab1e9";
    ...
    .then(function(response) {
      for (var i = 0; i < response.length; i++) {
        if (foundState == "Maine") {
          sliceDef =
            "state on the Atlantic coast in the northeastern U.S. and bordering on the Canadian provinces of Quebec and New Brunswick; capital Augusta area 33,265 square miles (86,156 square kilometers)";
          $("#basicInfo").append(sliceDef);
        }
        if (foundState == "Washington") {
          sliceDef =
            "state in the northwestern U.S. bordering the Pacific Ocean, the Strait of Juan de Fuca, Puget Sound, the Strait of Georgia, and British Columbia, Canada; capital Olympia area 68,192 square miles (177,299 square kilometers)";
          $("#basicInfo").append(sliceDef);
        }
        if (foundState == "Texas") {
          sliceDef =
            "state in the southern U.S. bordering on Mexico and the Gulf of Mexico; capital Austin area 266,807 square miles (691,030 square kilometers)";
          $("#basicInfo").append(sliceDef);
        }
        if (foundState == "Delaware") {
          sliceDef =
            "state of the eastern U.S. bordering on the Delaware River, Delaware Bay, and the Atlantic; capital Dover area 2057 square miles (5348 square kilometers)";
          $("#basicInfo").append(sliceDef);
        }
        if (foundState == "Illinois") {
          sliceDef =
            "state in the central part of the U.S. having the Mississippi River as its western boundary and bordering on Lake Michigan in the northeast; capital Springfield area 56,400 square miles (146,640 square kilometers)";
          $("#basicInfo").append(sliceDef);
          ...
          return (
            ...
            (searchString = "state"),
            (result = defArray.findIndex(i => {
              return i.startsWith(searchString);
            }, searchString)),
